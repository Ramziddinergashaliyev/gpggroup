...
//                     <h2 onClick={() => navigate(-1)} className='singleProduct-bg-text container'><FaArrowLeft />{data?.brand?.category?.nameRu}</h2>
//                 </div>
            ...
            <div className='singleProduct'>
                <div className="singleProduct-bg">
                    <h2 onClick={() => navigate(-1)} className='singleProduct-bg-text container'>
                        <FaArrowLeft />{data?.brand?.category?.nameRu}
                    </h2>
                </div>
                ...
                <div className="container">
                    ...
                    {selectData.length > 0 && (
                        <div className="single-cards">
                            {
                                selectData?.map((el) => (
                                    <div key={el.id} className="single-card" onClick={() => navigate(`/product/${el.id}`)}>
