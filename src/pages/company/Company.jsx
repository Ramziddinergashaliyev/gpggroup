  ...
  return (
    <div className="company">
      ...
      <div className="company__info container">
        <div className="company__info__left">
          <p className="company__info__left-desc">
            Компания ООО "Global Petrochemical Group" основана в 2011 году, в
            городе Ташкенте. Компания является лидером на рынке Узбекистана в
            области производства моторных масел, охлаждающих жидкостей и авто
            химии, отвечающим мировым стандартам.
          </p>
          <p className="company__info__left-desc">
            Все этапы производства (включая производство тары) проводятся на
            собственном технологическом оборудовании. Производится тщательный
        ...
        <div className="company__info__right">
          ...
          <p className="company__info__left-desc">
            Компания успешно прошла испытания в соответствующих лабораториях и
            имеет протоколы испытаний, а также имеет сертификацию Агенства
            стандартизации, метрологии и сертификации «Узстандарт» и получила
            допуск к производству и применению в транспортных средствах согласно
            UzTR 783-024:2017.
          </p>
        </div>
      </div>
      ...
      <p className="company__info__left-desc company__info__bottom-desc  container">
        Компания GPG работает совместно с крупнейшей мировой компанией S-Oil
        Corporation, Южная Корея, входящей в пятерку мировых лидеров по
        производству смазочных материалов для всех видов легкомоторной и тяжелой
        автотехники.
      </p>
    </div>
  );
