...
//   const [isMobile, setIsMobile] = useState(window.innerWidth < 768);
//   const [progress, setProgress] = useState(0);
//   // KEY FIX #1: animationKey — har slide o'zganda KenBurns qayta ishga tushadi
...
//       setActiveIndex(index);
//       setProgress(0);
//       // KEY FIX #2: animationKey ni oshirish — React active layer ni qayta mount qiladi
...
//           return (
//             <div
//               // KEY FIX #3: active layer uchun alohida key — animationKey o'zganda
//               // React bu elementni qayta yaratadi → animation qaytadan ishga tushadi
//               key={isActive ? `active-${animationKey}` : `slide-${index}`}
